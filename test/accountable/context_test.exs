defmodule Accountable.ContextTest do
  use ExUnit.Case
  use Plug.Test
  ...
  describe "assigns" do
    test "assigns current_user" do
      ...
      conn = conn(:get, "/") |> put_req_cookie("AccessToken", token) |> Context.call([])
  ...
  describe "absinthe context" do
    test "assigns current_user" do
      ...
      conn =
        ...
        |> Context.call(absinthe: Absinthe.Plug)
